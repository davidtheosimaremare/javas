...
const submitSettings = () => {
    form.post('/admin/news-editor/page-setting', {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => { /* Optional: Toast success */ }
    })
}
</script>

<template>
    <Head title="Manajemen Halaman Berita" />

    <AdminLayout>
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-slate-800 mb-0">Manajemen Halaman Berita</h3>
        </div>
        ...
        <div class="nova-card p-4 border-start border-5 border-navy">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <small class="text-muted">Mengatur banner judul di halaman Berita (News).</small>
                </div>
            </div>
                        ...
                        <div class="d-flex align-items-center gap-4 border rounded p-3 bg-light">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <ul class="text-muted small mb-0 ps-3">
                                    ...
                                    <li>Gambar ini akan muncul sebagai background header di <code>/news</code>.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="alert alert-light border mt-4 d-flex align-items-center text-muted">
            ...
            <div>
                <strong>Catatan:</strong> Untuk mengelola daftar artikel berita, silakan gunakan menu <strong>Berita & Artikel</strong> di sidebar. Halaman ini khusus untuk tampilan Header/Banner saja.
            </div>
        </div>
